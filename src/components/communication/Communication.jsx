...
const CONTACT_METHODS = [
  ...
  },
  {
    ...
    icon: FiGithub,
    label: 'GitHub',
    value: 'github.com/Mani7005',
    action: { type: 'link', href: 'https://github.com/Mani7005' },
  },
  {
    id: 'linkedin',
    icon: FiLinkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/rumani-dadyala-421a56313',
    action: { type: 'link', href: 'https://www.linkedin.com/in/rumani-dadyala-421a56313' },
  },
  {
    id: 'resume',
    icon: FiDownload,
    ...
    action: { type: 'download', href: '/Dadyala_rumani...pdf', filename: 'Rumani_Dadyala_Resume.pdf' },
  },
  {
    id: 'location',
    icon: FiMapPin,
